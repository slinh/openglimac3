...
int ObjLoader::FirstPass (FILE *fp)
{
  int v, t, n;
  char buf[256];
...
int ObjLoader::SecondPass (FILE *fp)
{
...
int ObjLoader::ReadOBJModel (const char *filename)
{
  FILE *fp;
